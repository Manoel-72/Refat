...
use crate::{editor::{EditorApp, EditorPlayState}, runtime::{camera, systems, RuntimeInput}};
...
pub fn apply_runtime_inputs(app: &mut EditorApp, ctx: &egui::Context) {
    ...
    if player_input != egui::Vec2::ZERO {
        systems::apply_player_controller_input(&mut scene.entities, &app.project_root, step, player_input);
    }
